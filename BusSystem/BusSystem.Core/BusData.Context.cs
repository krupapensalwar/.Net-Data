...
namespace BusSystem.Core
{
    ...
    public partial class BusReservationSystemDBEntities : DbContext
    {
        public BusReservationSystemDBEntities()
            : base("name=BusReservationSystemDBEntities")
        {
        ...
        public virtual DbSet<FareInfo> FareInfoes { get; set; }
        public virtual DbSet<PassengerInfo> PassengerInfoes { get; set; }
        public virtual DbSet<RouteInfo> RouteInfoes { get; set; }
